...
export const boidsSchema = {
  particleCount: countParam({ label: 'Boid Count', default: 1200, min: 50, max: 20000 }),
  ...
  containerSize: containerParam({ label: 'Container Size', default: 6, min: 2, max: 12 }),
  particleRadius: displaySizeParam({ label: 'Boid Size', default: 0.04, min: 0.02, max: 0.12 }),
} as const
