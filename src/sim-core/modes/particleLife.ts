...
export const particleLifeSchema = {
  ...
  forceRadius: { type: 'number', label: 'Force Radius', default: 0.5, min: 0.1, max: 1.5, step: 0.05, unit: 'm' },
  ...
  damping: { type: 'number', label: 'Damping', default: 1.5, min: 0.1, max: 5, step: 0.1, unit: '1/s' },
  containerSize: { type: 'number', label: 'Container Size', default: 4, min: 2, max: 10, step: 0.5, unit: 'm' },
  particleRadius: { type: 'number', label: 'Particle Size', default: 0.05, min: 0.02, max: 0.15, step: 0.01, unit: 'm' },
} as const
